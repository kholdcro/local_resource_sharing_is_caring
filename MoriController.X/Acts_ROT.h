...
bool Acts_ROT_InRange(uint8_t, uint16_t);
...
// velocity functions
volatile uint16_t Acts_ROT_SendVelTarget(uint8_t); 
void Acts_ROT_VEL(uint8_t);
float Acts_ROT_GetVelTarget(uint8_t);
void Acts_ROT_SetVelTarget(uint8_t, float);
float Acts_ROT_GetVelNeighbourTarget(uint8_t);
void Acts_ROT_SetVelNeighbourTarget(uint8_t, int16_t);

void Acts_ROT_SaveSPD(uint8_t, float);
float Acts_ROT_GetSPD(uint8_t);

void Acts_ROT_SaveUnsaniTarget(uint8_t, float);
float Acts_ROT_GetUnsaniTarget(uint8_t);
