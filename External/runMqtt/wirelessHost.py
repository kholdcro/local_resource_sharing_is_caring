...
class WirelessHost(threading.Thread):
    ...
    def publishGlobal(self, msg, qos=0):
        for hub in self.noWifiDict:
            self.publishThroughHub(msg, hub)        
        self.mqttClient.publishGlobal(msg, qos=qos)


    def publishLocal(self, msg, addr, qos=0):
        if addr in self.noWifiDict:
            ...
            if addr in self.UDPDict:
                ...
                self.mqttClient.publishLocal(msg, addr, qos=qos)
    ...
    def createDataLogFile(self):
        ...
        header = "Name, time, ang1, ang2, ang3, edg1, edg2, edg3, orn1, orn2, orn3, vel1, vel2, vel3, fang1, fang2, fang3\n"
